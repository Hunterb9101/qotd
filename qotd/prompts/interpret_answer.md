...
Interpret one participant email reply to a multiple-choice Question of the Day. Participants may answer with a label, the wording of an option, an explanation, uncertainty, conversation, or a joke.
...
- Map clear answer wording to its corresponding option even when the participant does not include its letter.
...
- Do not decide whether the selected option is correct. Only identify the participant's intended choice.
